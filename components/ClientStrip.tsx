        ...
        <div className="flex flex-wrap items-center justify-center gap-x-14 gap-y-6">
          {clients.map((client) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group flex flex-col items-center gap-1 text-center transition-opacity hover:opacity-70"
              aria-label={`${client.name} — ${client.type}`}
            >
              <span
                className="font-sans text-[0.9375rem] font-700 tracking-[-0.02em] transition-colors group-hover:text-[var(--accent)]"
